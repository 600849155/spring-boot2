...
public class KafkaPrividerController {
    ...
    private final KafkaSendResultHandler producerListener;

    public KafkaPrividerController(KafkaSendResultHandler producerListener, KafkaTemplate<String, String> template) {
    ...
    public String send(@RequestParam String topic, @RequestParam String msg) {
        ...
        GenericMessage<String> message = new GenericMessage<>(msg, new MessageHeaders(map));
    ...
    public String producerListen(@RequestParam String topic, @RequestParam String msg) {
        template.send(topic, msg);
        return "success";
    }
