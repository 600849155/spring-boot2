...
public class TopicController {
    ...
    public TopicController(AdminClient adminClient) {
    ...
    public String createTopic(String topicName,int partitions,int replicationFactor){
        adminClient.createTopics(Collections.singletonList(new NewTopic(topicName, partitions, (short) replicationFactor)));
